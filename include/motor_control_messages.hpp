 ...
 * Generated at: 2025-12-09T01:45:42.668595
 *
...
struct ReceivedData {
     ...
     */
    static ReceivedData fromBytes(const uint8_t* buffer, size_t len) {
        ReceivedData obj;
...
#pragma pack(pop)
static_assert(sizeof(ReceivedData) == 36, "Size mismatch for ReceivedData");
...
struct SentData {
     ...
     * @param buffer Input buffer
     * @param len Buffer length
     * @return SentData object
     */
    static SentData fromBytes(const uint8_t* buffer, size_t len) {
        SentData obj;
        obj.deserialize(buffer, len);
        return obj;
    }
...
#pragma pack(pop)
static_assert(sizeof(SentData) == 120, "Size mismatch for SentData");
